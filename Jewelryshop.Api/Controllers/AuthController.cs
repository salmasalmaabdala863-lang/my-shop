...
public class AuthController : ControllerBase
{
    ...
    public AuthController(AppDbContext dbContext, PasswordService passwordService, JwtService jwtService)
    {
    ...
    public async Task<ActionResult<AuthResponse>> Register(RegisterRequest request)
    {
        ...
        return Ok(new AuthResponse(user.Id, user.FullName, user.Email, user.Role, _jwtService.GenerateToken(user)));
    }
